...
- Use anoter source as input for the enrichment (example Google Vision AI on rosetta images, Google speech-to-text on audio from YouTube)
...
new json records will be created. The records will be formated with the schema.org and prov: 
- datamodel and will contain the ID from ES 
